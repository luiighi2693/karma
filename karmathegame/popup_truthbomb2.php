                                                ...
                                                <td align="left">
                                                    ...
                                                    <div style="display: flex;">
                                                        ...
                                                        <div style="background-color: white;margin: 2px;">
                                                            ...
                                                            <textarea id="txtAreaUserForSend" style="border-top: hidden;margin-left: 20px;border-left: none;" rows="17" cols="32"><?echo $answerSelectedArray['answer']?></textarea>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                    ...
                                    <td width="25%" align="left" valign="top"  >
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" height="190" valign="middle">
                                                    <?
                                                    echo '<h3 style="text-align: right;color: white;    padding-bottom: 10px;">'.$userFromArray['username'].'</h3>';
                                                    ?>

                                                    <img src="<? echo GetAvatarImage($userFromArray['avatarid'],'big');?>" alt="" width="100%" height="295px"/>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%" align="right" style="padding-top:20px;" colspan="2">
                                                    <a href="#" onclick="saveAnswer(<? echo $_SESSION['UsErIdFrOnT'].', '.$questionSelectedArray['id'].', '.$userFromArray['id'].', '.$torbComplement.', '.$questionSelectedArray['id'].', '.$mailAcepted;?>);hide_pop();return false;"><img src="images/send-button-green.png" border="0" /></a>
