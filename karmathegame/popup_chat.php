...
<form name="frmpopup" id="frmpopup" enctype="multipart/form-data" method="post" onmouseover="if(document.getElementById('frmpopup')!=null){
	...
	<div class="header">
			<div class="top_info">
				...
				<? if($_REQUEST['iconcolor']=="white"){?><img src="images/icon_chat_white.png" height="100%" width="100%" style="margin-top:0px;" /><? }else{?><img src="images/icon_chat_black.png".png" height="100%" width="100%" style="margin-top:0px;" /><? } ?>
