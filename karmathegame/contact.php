...
// Set email variables
$email_to = 'rene.reyes@alquimi.com';
...
<style>
		...
		background-border:0px 5px 0px 5px;
		}
		</style>
<div id="formWrap">
  <div id="question">Would you like to be a part of the testing team? or just leave a comment.</div>
  <div id="form">
    ...
    <?php else: ?>
    <p style="font-size:30px; font-family:Arial, Helvetica, sans-serif; Margin-left:75px;">Thank you for your Message!</p>
    <script type="text/javascript">
