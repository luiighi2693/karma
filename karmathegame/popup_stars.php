...
<form name="frmpopup" id="frmpopup" enctype="multipart/form-data" method="post">
	...
	<div class="middlesection">
		<div class="centered_info">
			...
			<div class="avatar_pic">
			 ...
			 <div align="center"><iframe src="stars_reading.php?id=<? echo $_REQUEST['id'];?>&from=<? echo $_SESSION['UsErIdFrOnT'];?>&to=<? echo mysql_real_escape_string($_REQUEST['id']);?>" width="100%" height="80%"  scrolling="yes"  frameborder="0"></iframe></div>
	...
	<div class="footer">
		<div class="centered_info">
			...
			<div class="button">
				<input  type="image" name="sendbutton" id="sendbutton" src="images/send-button.png" onclick="return POPUPfrmcheck('hidepop');" />
			</div>
