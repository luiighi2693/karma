		...
		<div class="centered_info">
			...
			<div style="width: 20%; height:100%;display:inline-block;float:left;overflow: auto;padding-left:1%;">
				...
				<? }?>
					...
					?>
					<? if($getPicsQryRow3['type']=='Music'){?><img style="padding-bottom: 5%;padding-left: 2%; padding-top: 5%;" id="MainMusic" src="images/shareMusic.png" width="100%" height="100"/><? }?><a href="#" onClick="openWinFullwidth('viewpics.php?userid_from=<? echo $_REQUEST['id'];?>&color1=<? echo $_REQUEST['color1'];?>&userid_to=<? echo mysql_real_escape_string($_SESSION['UsErIdFrOnT']);?>&type=Music','usedadasr<?=rand();?>',1024,480,'yes','yes')"  class="dashboard_whitetext" style="font-size:10px;text-decoration:none;float: left; padding-left: 2%;">CLICK TO VIEW MUSIC</a>
				<? }?>
				<? }?>
			</div>
			<div style="display:inline-block;height:80%;width:55%;margin-left:4%;" >
					...
					<div style="width: 100%;">
						<img src="images/sharePicture.png" href="#" style="width:33%;height:100%;" onClick="openInNewTab('update_pictures_videos.php?TYPE=Picture&color1=<? echo $_REQUEST['color1']?>&userid_to=<? echo $_REQUEST['id'];?>')"/>
						<img src="images/shareVideo.png" href="#" style="width:33%;height:100%;"  onClick="openInNewTab('update_pictures_videos.php?TYPE=Video&color1=<? echo $_REQUEST['color1']?>&userid_to=<? echo $_REQUEST['id'];?>')"/>
						<img src="images/shareMusic.png" href="#" style="width:33%;height:100%;"  onClick="openInNewTab('update_pictures_videos.php?TYPE=Music&color1=<? echo $_REQUEST['color1']?>&userid_to=<? echo $_REQUEST['id'];?>')"/>
					</div>
			</div>
		</div>
	</div>
