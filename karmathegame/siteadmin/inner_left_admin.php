  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<? }else if($mlevel==10){?>
			...
			<tr>
				<td height="29" class="mail_font">Anim Loops Management</td>
			</tr>
			<tr>
				<td height="29" class="menuon" onClick="javascript:document.location.href='manage_anim_loops.php';" onMouseOver="className='menuover';" onMouseOut="className='menuon';">Manage Anim Loops</td>
			</tr>
			<tr>
				<td height="20" class="menuon" onClick="javascript:document.location.href='add_anim_loops.php';" onMouseOver="className='menuover';" onMouseOut="className='menuon';">Add Anim Loops</td>
			</tr>
		<? } ?>
	  </table></td>
  </tr>
