...
{	
	...
	$dqry="delete from options_group where id=$cid";
	mysql_query($dqry);	
	header("location:manage_option_group.php?msgs=15");
	exit;
}
...
$order=$_GET["order"];
$strQueryPerPage="select * from options_group where name like '$order%'   $ANDQRY2 $ORDQry ";
...
{
	$Message2 = "Option Group Added Successfully!!";
}
if($_GET["msgs"]==3 && !$_GET["start"])
{
	$Message2 = "Option Group Updated Successfully!!";
}
if($_GET["msgs"]==15 && !$_GET["start"])
{
	$Message2 = "Option Group Deleted Successfully!!";
}
?>
      ...
      <td width="80%" valign="top"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td align="left" height="35" class=form111>Manage Option Group </td>
				<td align="right" height="35" class=form111><input type="button" name="addddd" value="Add Option Group" onClick="window.location.href='add_option_group.php'" class="bttn-a" ></td>
			  </tr>
			</table>
			</td>
          </tr>
                    ...
                    <table width="70%" border="0"   cellspacing="1" cellpadding="1" align="center" >
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-a2">
                            <tr>
                              <td class=th-a><div align="center" ><strong>No Option Group To Display</strong></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                      ...
                      <form id="passionmanage" name="passionmanage"  method="post" action="#" enctype="multipart/form-data">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-b">
						  ...
						  <? if($_REQUEST['db_pages']!=''){$db_pages=$_REQUEST['db_pages'];}else{$db_pages=50;}?>
                            ...
                            <tr class="form_back" >
							  <td width="90%" height="20"  align="left"><strong>Option Group</strong></td>
						  ...
						  ?>
                            <tr>
							  ...
							  <td  align="center" nowrap="nowrap">
							   <input name="button" type="button" onClick="window.location.href='add_option_group.php?id=<?php echo $row->id; ?>'" value="Edit" title="Edit" class="bttn-s">
							  <input name="button2" type="button" onClick="deleteconfirm('Are you sure you want to delete <? echo $row->name; ?>? \n','manage_option_group.php?id=<?php echo($row->id); ?>');" value="Delete" title="Delete" class="bttn-s">
							  </td>
