...
{	
	$cid=$_GET["id"];	
	$dqry="delete from torb_questions where id=$cid";
	mysql_query($dqry);	
	header("location:truth.php?msgs=15");
	exit;
}

$strQueryPerPage="select torb_questions.* from torb_questions 
					where 1=1
					$andqry
					order by id desc ";
...
if($_GET["msgs"]==1)
{
	$Message2 = " truth Added Successfully!!";
}
if($_GET["msgs"]==3)
{
	$Message2 = " truth Updated Successfully!!";
}
if($_GET["msgs"]==15)
{
	$Message2 = " truth Deleted Successfully!!";
}
if($_GET["msgs"]==5)
{
...
if($_GET["msgs"]==333)
{
	$Message2 = " truth Setted Successfully!!";
}
if($_GET["msgs"]==3333)
{
...
if($_GET["msgs"]==4)
{
	$Message2 = " truth has been updated successfully"; 
}
?>
<html>
<HEAD>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="80%" valign="top"><table width="100%"  border=0 cellpadding="2" cellspacing="2">
          <tr>
            <td width="100%" height="35" class=form111>Truth </td>
          </tr>
          <tr>
                    ...
                    <table width="70%" border="0"   cellspacing="1" cellpadding="1" align="center" >
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-a2">
                            <tr>
                              <td class=th-a><div align="center" ><strong>There are no truth to display</strong></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                      ...
                      <table width="100%" border=0 cellspacing=0 cellpadding="0" class="t-b">
                        <tbody>
                          ...
                          <tr class="form_back">
							...
							<td width="20%" align="left" nowrap="nowrap"><strong>Group Id</strong></td>
							<td width="40%" align="left" nowrap="nowrap"><strong>Torb Question</strong></td>
                          ...
                          <tr>
							...
							<td align="left" valign="top"  ><? if(stripslashes($row->groupid)==1){ echo "Compatibility";} if(stripslashes($row->groupid)==2){ echo "Values";} if(stripslashes($row->groupid)==3){ echo "Intimate Preferences";}?></td>
							<td align="left" valign="top"  ><? echo stripslashes($row->torb_question); ?></td>
							
							<td  align="center"  nowrap="nowrap"  valign="top">
							<input name="button3" type="button" onClick="window.location.href='add_truth.php?id=<?php echo($row->id); ?>'" value="Edit" class="bttn-s">
							<input name="button2" type="button" onClick="deleteconfirm('Are you sure you want to delete this truth? \n','truth.php?id=<?php echo($row->id); ?>');" value="Delete" class="bttn-s">
