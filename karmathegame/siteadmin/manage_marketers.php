...
{	
	...
	$dqry="delete from marketers where id=$cid";
	mysql_query($dqry);	
	header("location:manage_marketers.php?msgs=15");
	exit;
}
...
$order=$_GET["order"];
$strQueryPerPage="select * from marketers where firstname like '$order%'   $ANDQRY2 $ORDQry ";
$_SESSION["EXPORT_MARKETER_QRYY"]=$strQueryPerPage;
...
{
	$Message2 = "Marketer Added Successfully!!";
}
if($_GET["msgs"]==3 && !$_GET["start"])
{
	$Message2 = "Marketer Updated Successfully!!";
}
if($_GET["msgs"]==15 && !$_GET["start"])
{
	$Message2 = "Marketer Deleted Successfully!!";
}
?>
      ...
      <td width="80%" valign="top"><table width="100%"  border="0" cellpadding="2" cellspacing="2">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td align="left" height="35" class=form111>Manage Marketer </td>
				<td align="right" height="35" class=form111><input type="button" name="addddd" value="Add Marketer" onClick="window.location.href='add_marketers.php'" class="bttn-a" >&nbsp;<input type="button" class="bttn-a" value="EXPORT" onClick="window.location.href='exportmarketers.php'"></td>
			  </tr>
			</table>
			</td>
          </tr>
                    ...
                    <table width="70%" border="0"   cellspacing="1" cellpadding="1" align="center" >
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-a2">
                            <tr>
                              <td class=th-a><div align="center" ><strong>No Marketer To Display</strong></div></td>
                            </tr>
                          </table></td>
                      </tr>
                    </table>
                      ...
                      <form id="passionmanage" name="passionmanage"  method="post" action="#" enctype="multipart/form-data">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="t-b">
						  ...
						  <? if($_REQUEST['db_pages']!=''){$db_pages=$_REQUEST['db_pages'];}else{$db_pages=50;}?>
                            ...
                            <tr class="form_back" >
							  <td width="26%" height="20"  align="left"><strong>Full Name </strong></td>
							  <td width="28%" height="20"  align="left"><strong>Phone Number</strong></td>
							  <td width="4%" height="20"  align="left"><strong>Code </strong></td>
							  <td width="28%" height="20"  align="left"><strong>Email </strong></td>
							  <td width="4%" height="20" nowrap="nowrap"  align="left"><strong>Recruited By </strong></td>
							  <td width="4%" height="20"  align="left"><strong>Date </strong></td>
						  ...
						  ?>
                            <tr>
							  ...
							  <td align="left"><? echo stripslashes($row->phone); ?>&nbsp;</td>
							  <td align="left" nowrap="nowrap"><? echo stripslashes($row->code); ?>&nbsp;</td>
							  <td align="left"><? echo stripslashes($row->email); ?>&nbsp;</td>
							  <td align="left" nowrap="nowrap"><? echo stripslashes($row->recruitedby); ?>&nbsp;</td>
							  <td align="left" nowrap="nowrap"><? echo date("m/d/Y",strtotime($row->addeddate)); ?>&nbsp;</td>
							  <td  align="center" nowrap="nowrap">
							   <input name="button" type="button" onClick="window.location.href='add_marketers.php?id=<?php echo $row->id; ?>'" value="Edit" title="Edit" class="bttn-s">
							  <input name="button2" type="button" onClick="deleteconfirm('Are you sure you want to delete marketer? \n','manage_marketers.php?id=<?php echo($row->id); ?>');" value="Delete" title="Delete" class="bttn-s">
							  </td>
                            </tr>
                            <? } ?>
