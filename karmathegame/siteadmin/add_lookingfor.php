...
if(isset($_POST['Submit']))
{
   if($_GET['id'])
   {
		$sql="UPDATE lookingfor SET 
				name='".addslashes($_POST["name"])."'  where id='".trim($_GET['id'])."'";	
		$q=mysql_query($sql);
		
		header("location:manage_lookingfor.php?msgs=3");
		exit;
	}
	else
	{
		$sql="INSERT INTO lookingfor SET 
				name='".addslashes($_POST["name"])."'";	
		$q=mysql_query($sql);
		$insertedid=mysql_insert_id();
		
		header("location:manage_lookingfor.php?msgs=1");
		exit;
	}		
}
...
if($_GET['id'])
{
	...
	$SEL="SELECT * from lookingfor where id='".$_GET['id']."'";
        ...
        <tbody >
          <tr>
            ...
            <td width="80%" valign="top" align="center"><table width="100%"  border=0 cellpadding="2" cellspacing="2">
                <tr>
                  <td height="35" class="form111"><? if($_GET['id']){?>Edit<? } else {?>Add<? } ?> Looking For</td>
                </tr>
                <tr>
                  <td height="222" class="formbg" valign="top">
                      ...
                      <table cellspacing="2" cellpadding="2" width=98% border="0" class="t-b">
                        ...
                        <? }?>
                        <tr>
                          <td width="19%" height="25" align="right" valign="top"><strong><span class="a">*</span> Looking For:&nbsp;</strong></td>
