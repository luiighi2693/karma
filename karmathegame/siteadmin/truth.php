...
{	
	...
	mysql_query($dqry);	
	header("location:manage_truth.php?msgs=15");
	exit;
}
                      ...
                      <table width="100%" border=0 cellspacing=0 cellpadding="0" class="t-b">
                        <tbody>
                          ...
                          <tr>
							...
							<td align="left" valign="top"  ><? echo stripslashes($row->groupid); ?></td>
